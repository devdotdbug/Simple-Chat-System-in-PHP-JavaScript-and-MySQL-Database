<div class="w3-modal" id="photoUploader">
    <div class="w3-modal-content w3-container w3-mobile" style="width:50%;">
        <header class="w3-container w3-stretch w3-black">
            ...
            <h3 style="width:95%;">Choose a photo to upload...</h3>
        </header>
        <section class="w3-container w3-center">
            ...
            <form method="post" action="./c.con/engine.php" enctype="multipart/form-data">
                <input type="file" name="photo" class="w3-input w3-margin">
                <input type="submit" name="uploadPhoto" value="Upload Photo" class="w3-button w3-pale-green">
            </form>
        </section>
    </div>
</div>